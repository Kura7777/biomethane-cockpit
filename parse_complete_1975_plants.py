...
print(f'Successfully parsed {len(parsed_plants)} full biomethane plants from Excel sheet!')
...
print(f'Generated registry.ts with ALL {len(parsed_plants)} PLANTS from your uploaded sheet!')
