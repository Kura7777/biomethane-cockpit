...
print("Cleaning and sorting registry by Country ISO and Capacity...")
...
# Sort by Country ISO, then Capacity descending, then Name
...
print(f"Constructed {len(biomethane_plants)} sorted BiomethanePlant objects.")
...
print("Updated src/domain/plants/registry.ts.")

# Also update CSV and Excel
df.to_csv(csv_file, index=False, encoding='utf-8')
print(f"Sorted CSV saved to: {csv_file}")
