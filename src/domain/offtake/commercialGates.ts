...
export function evaluateCommercialGates(
  ...
  if (isHeatingBasisExplicit) {
    gates.push({
      ...
      remedy: null,
      citations: [{
        shortName: 'EFET / Bilateral §25.2',
        fullReference: 'EFET General Agreement Annex & Bilateral Indicative Term Sheet §25.2',
        establishes: 'Gross Higher Heating Value (HHV) vs Net Lower Heating Value (LHV) conversion standard (0.901 factor).',
        sourceUrl: 'Market convention — European physical bilateral standard (EFET Biomethane Schedule)',
  ...
  const isCompressionExplicit = true; // In institutional two-leg structure, baseline CI is at plant gate
  if (isCompressionExplicit) {
    gates.push({
      ...
      remedy: null,
      citations: [{
        shortName: 'Bilateral §25.4 / RED III',
        fullReference: 'Institutional Indicative Term Sheet §25.4 & RED III Annex V GHG Methodology',
  ...
  if (isFactorExplicit) {
    ...
    gates.push({
      ...
      remedy: null,
      citations: [{
        shortName: 'Bilateral Indicative §25.1',
        fullReference: 'Institutional Indicative Term Sheet §25.1',
  ...
  if (marketImpliedAlpha !== null) {
    ...
    gates.push({
      ...
      citations: [{
        shortName: 'Bilateral Term Sheet §25.5',
        fullReference: 'Institutional Indicative Term Sheet §25.5',
  ...
  if (isVolumeCapped) {
    gates.push({
      ...
      remedy: null,
      citations: [{
        shortName: 'Bilateral Term Sheet §25.3',
        fullReference: 'Institutional Indicative Term Sheet §25.3',
  ...
  gates.push({
    ...
    remedy: null,
    citations: [{
      shortName: 'Bilateral Term Sheet §25.7',
      fullReference: 'Institutional Indicative Term Sheet §25.7 Invoicing & Payment Terms',
  ...
  gates.push({
    ...
    remedy: null,
    citations: [{
      shortName: 'Bilateral Term Sheet §25.8',
      fullReference: 'Institutional Indicative Term Sheet §25.8 Conditions Precedent & Cross-Default',
  ...
  gates.push({
    ...
    remedy: null,
    citations: [{
      shortName: 'Bilateral Term Sheet §25.4/§25.6',
      fullReference: 'Institutional Indicative Term Sheet §25.4 (Rejection), §25.6 (Support), §25.9 (Prolongation)',
